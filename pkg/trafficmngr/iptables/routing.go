...
// NewRouter creates a new router object.  The router returned by NewRouter currently does
// not update its routes after construction... care should be taken for
// long-running programs to call NewRouter() regularly to take into account any
// changes to the routing table which have occurred since the last NewRouter() call.
